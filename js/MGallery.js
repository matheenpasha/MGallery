...
(function (window, document, Math) {
  ...
  var utils = (function(){
    ...
    me.setAttr = function(e, a, x){
      if(!e || (typeof e === 'undefined')){
        return null;
      }
      return e.setAttribute(a, x);
    };

    me.getAttr = function(e, a){
    ...
    me.has = function(obj, key){
      return obj != null && hasOwnProperty.call(obj, key);
    };

    me.keys = function(obj){
      if(!me.isObject(obj)) return [];
      if(nativeKeys) return nativeKeys(obj);
      var keys = [];
      for(var key in obj) if(me.has(obj, key)) keys.push(key);
      return keys;
    };

    me.each = function(obj, iteratee, context){
    ...
    me.calculateCombinedWidth = function(xs){
      var width = 0;
      me.each(xs, function(el){
...
// INSERT POINT: indicator._move
  ...
  MGallery.prototype = {
    ...
    onOpen: function() {
      ...
      //Build the Gallery
      !this.isGalleryReady ? this.buildGallery() : '';
    ...
    _attachEvents: function() {
      ...
      utils.addEvent(mGallery.closeButton, 'click', function(){
        mGallery.isControlsShowing ? mGallery.hideControls() : '';
        mGallery.hide();
      }, false);
    ...
    _resize: function(){
      ...
      mGallery.scroller == null ? mGallery.scroller = new IScroll(mGallery.getViewPort(), mGallery.options.carouselConfig) : mGallery.scroller.refresh();
